...
(function() {
    ...
    function createUI() {
        GM_addStyle(`
            ...
            #gemini-ocr-save-btn { background-color: #2ecc71 !important; /* A shade of bright green */ color: white !important; /* To ensure the text is visible */}
            #gemini-ocr-save-btn:hover { background-color: #27ae60 !important; /* A slightly darker green for the hover effect */} `);
